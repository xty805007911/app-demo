<template>
    <div class="card">
        <h2>我的名片</h2>
        <p>网名：肖天宇 | Xiaotianyu</p>
        <p>职业：程序员</p>
        <p>现居：中国 | 北京</p>
        <p>805007911@qq.com</p>
        <ul class="linkmore">
            <li><a href="/" target="_blank" class="iconfont icon-zhuye" title="网站地址"></a></li>
            <li><a href="http://wpa.qq.com/msgrd?v=3&uin=805007911&site=qq&menu=yes" target="_blank" class="iconfont icon---" title="QQ联系我"></a></li>
